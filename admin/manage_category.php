    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
              ...
              ?>
                    <h1 class="tittle display-1 text-center">Manage Category</h1>
                </div>
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><a class="text-primary display-4" href="category_edit.php?id=<?php echo $row['id']?>">&#9997;</a></td>
                    <td><a class="text-danger display-4" href="category_delete.php?id=<?php echo $row['id']?>"><i class="bi bi-trash-fill"></i></a></td>
                  </tr>
                <?php $s++; } ?>
                </table>
                </div>
