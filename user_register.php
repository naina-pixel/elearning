    ...
    <form  class="form-default" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="login-form">  <!-- logo-login -->
           ...
           <div class="form-input pt-30">
            ...
            <!-- Forget Password -->
            <h5 class="text-light">Already have an account?</h5>
            <a href="user_login.php" class="registration">login</a>
        </div>
    </form>
    <!-- /end login form -->
</main>
...
<?php
    ...
    if($result>0)
    {
        ...
        echo "<script>window.location.assign('user_login.php?msg=CONGRATS REGISTRATION DONE')</script>";
    }
    else{
